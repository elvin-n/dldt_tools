...
bool SNPEBackend::loadModel(const VLauncher *launcher, const std::string &device,
    ...
    try {
        ...
        container = zdl::DlContainer::IDlContainer::open(zdl::DlSystem::String(launcher->model_.c_str()));
