...
bool TFLiteBackend::loadModel(const VLauncher *launcher, const std::string &device,
    ...
    try {
        ...
        _model = tflite::FlatBufferModel::BuildFromFile(launcher->model_.c_str());
        if (!_model) {
        ...
        if (device == "GPU16" || device == "GPU32") {
#if defined(__ANDROID__)
          TfLiteGpuDelegateOptionsV2 gpu_opts = TfLiteGpuDelegateOptionsV2Default();
          gpu_opts.inference_preference =
            TFLITE_GPU_INFERENCE_PREFERENCE_SUSTAINED_SPEED;
          gpu_opts.inference_priority1 =
            device == "GPU16" ? TFLITE_GPU_INFERENCE_PRIORITY_MIN_LATENCY
